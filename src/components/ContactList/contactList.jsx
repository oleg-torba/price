                    ...
                    <li className="contactsItem" key={item.name}>
                      <div className="contact">
                        ...
                        <span>
                          ...
                          <span className='itemValue'>{priceLCD} грн</span> 
                        </span>
                        <span>
                          <span className="contactValue">Заміна скла дисплею:</span>
                          <span className='itemValue'> {changeGlass} грн</span> 
                         
                        </span>
                        <span>
                          <span className="contactValue">Наявність:</span>
                          <span className='itemValue'>{item.quantity_in_stock} шт</span> 
                        </span>
                  ...
                  <>
                    <li className="contactsItem" key={item.name}>
                      ...
                      <span>
                        ...
                        <span>
                          <span className="contactValue">Ціна:</span>
                          <span className='itemValue'>{priceCharge} грн</span> 
